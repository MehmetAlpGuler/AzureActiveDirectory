...
public class AADAuthenticationFilter extends OncePerRequestFilter {
    ...
    /*public AADAuthenticationFilter(AADAuthenticationProperties aadAuthProps,
        ...
        this.principalManager = new UserPrincipalManager(resourceRetriever);
    }*/

    public AADAuthenticationFilter() {
        this.aadAuthProps = new AADAuthenticationProperties();
        this.resourceRetriever = AADAuthenticationFilterAutoConfiguration.getJWTResourceRetriever();
        this.principalManager = new UserPrincipalManager(resourceRetriever);
    }
        ...
        if (authHeader != null && authHeader.startsWith(TOKEN_TYPE)) {
            try {
                ...
                final AzureADGraphClient client =
                        new AzureADGraphClient(credential, aadAuthProps);
