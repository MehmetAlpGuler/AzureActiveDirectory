...
public class AADOAuth2UserService implements OAuth2UserService<OidcUserRequest, OidcUser> {
    ...
    private AADAuthenticationProperties aadAuthProps = new AADAuthenticationProperties();
    ...
    public OidcUser loadUser(OidcUserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        try {
            ...
            final AzureADGraphClient graphClient = new AzureADGraphClient(credential, aadAuthProps);

            graphApiToken = graphClient.acquireTokenForGraphApi(idToken.getTokenValue(), aadAuthProps.getTenantId()).getAccessToken();
